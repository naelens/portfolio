        ...
        <div id="sobreMim" className="flex flex-col py-10 sm:py-20 px-12 sm:px-7.5rem font-inter bg-gray-950">
            ...
            <section>
                    ...
                    <section className="grid grid-cols-1 sm:grid-cols-2 gap-14 mt-8">
                        <div>
                            <h2 className="flex gap-3 items-center text-sm sm:text-base font-semibold text-bglinear">Minhas Skills</h2>
                            <ul className="flex flex-wrap gap-4 mt-6">
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-bglinear rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                ...
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-bglinear rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="src\assets\tailwindcss-original.svg" alt="Tailwind ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-bglinear rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                        ...
                        <div>
                            <h2 className="flex gap-3 items-center text-sm sm:text-base font-semibold text-bglinear">Meus serviços</h2>
                            <div className="flex gap-4 mt-6">
                                <div className="flex flex-col justify-center items-center px-2 border border-bglinear rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <div className="text-bglinear p-2 rounded-full border border-bglinear"><Code size={20} /></div>
                                    <h2 className="mt-4 text-gray-50 text-xs sm:text-sm">Desenvolvimento Web</h2>
                                    <p className="text-gray-600 text-xs sm:text-sm mt-3 text-center">Criação de Sites e Landing Pages.</p>
                                </div>
                                <div className="flex flex-col justify-center items-center px-2 border border-bglinear rounded-lg shadow-lg shadow-gray-500/20 p-4 bg-gray600">

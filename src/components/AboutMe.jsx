                    ...
                    <section className="grid grid-cols-1 xl:grid-cols-2 gap-10 sm:gap-14 mt-8 2xl:mt-12">
                        <div>
                            ...
                            <ul className="flex flex-wrap gap-4 sm:gap-4 mt-6">
                                ...
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="css3-original.svg" alt="CSS3 ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="javascript-original.svg" alt="Javascript ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="react-original.svg" alt="React ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="angularjs-original.svg" alt="Angular ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="typescript-original.svg" alt="Typescript ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="tailwindcss-original.svg" alt="Tailwind ícone" />
                                </div>
                                <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="figma-original.svg" alt="Figma ícone" />
                                </div>
                               <div className="flex flex-col justify-center items-center p-2 sm:p-3 border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 bg-gray600">
                                    <img className="h-10 sm:h-12" src="git-original.svg" alt="Git ícone" />
                                </div>   
                            </ul>
                        </div>
                        <div>

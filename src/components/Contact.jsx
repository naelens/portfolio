            ...
            <div className="border border-purple-400 rounded-lg shadow-lg shadow-gray-500/20 p-4 sm:p-8 sm:w-40rem">
                ...
                <form action="https://getform.io/f/bvrrgxob" method="POST" className="mt-5 sm:mt-10" >
                    ...
                    <div className="flex justify-center mt-8">
                        <button type="submit" className="px-4 py-2 sm:px-6 sm:py-2 rounded-md text-xs sm:text-base font-medium text-gray-50 hover:bg-purple-400 bg-purple-500 hover:text-white transition duration-300 ease-in-out">Enviar</button>
                    </div>

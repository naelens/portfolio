        ...
        <div id="projetos" className="flex flex-col py-10 sm:py-20 px-8 sm:px-7.5rem font-inter bg-gray-950">
            ...
            <section className="flex flex-wrap gap-6 mt-12">
                <div className="w-auto sm:w-80 2xl:w-96 rounded-xl transform hover:scale-105 transition duration-300">
                    <img className="rounded-tl-xl rounded-tr-xl" src="/assets/postify-projeto.png" alt="Imagem do projeto Postify" />
                ...
                <div className="w-auto sm:w-80 2xl:w-96 rounded-xl transform hover:scale-105 transition duration-300">
                    <img className="rounded-tl-xl rounded-tr-xl" src="/assets/to-do-projeto.png" alt="Imagem do projeto Postify" />
                ...
                <div className="w-auto sm:w-80 2xl:w-96 rounded-xl transform hover:scale-105 transition duration-300">
                    <img className="rounded-tl-xl rounded-tr-xl" src="/assets/glasses-projeto.png" alt="Imagem do projeto Glasses" />
                ...
                <div className="w-auto sm:w-80 2xl:w-96 rounded-xl transform hover:scale-105 transition duration-300">
                    <img className="rounded-tl-xl rounded-tr-xl" src="/assets/findmyplace-projeto.png" alt="Imagem do projeto Find My Place" />
